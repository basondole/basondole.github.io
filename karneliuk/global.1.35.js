...
function readyFn (jQuery) {
	...
	jQuery('.alia_gototop_button.alia_gototop_visible').live('click touchend', function () {
	...
	jQuery('.alia_cookie_accept_area .cookies_accept_button').live('click', function (e) {
	...
	if (jQuery("body.sticky_header .header_nav_wrapper").length) {
		...
		var headerNavArea = jQuery("body.sticky_header .header_nav_wrapper"),
			headerNavHeight = 0,
	...
	if (jQuery('.header_nav .main_menu > ul.navbar > li.menu-item.current-menu-item, .header_nav .main_menu > ul.navbar > li.menu-item.current_page_item, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-ancestor, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-parent').length) {
		var currentMenuPos = jQuery('.header_nav .main_menu > ul.navbar > li.menu-item.current-menu-item, .header_nav .main_menu > ul.navbar > li.menu-item.current_page_item, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-ancestor, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-parent').position();
		var currentMenuWidth = jQuery('.header_nav .main_menu > ul.navbar > li.menu-item.current-menu-item, .header_nav .main_menu > ul.navbar > li.menu-item.current_page_item, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-ancestor, .header_nav .main_menu > ul.navbar > li.menu-item.current-menu-parent').width();
	...
	------------------------------------------- */
	jQuery(".header_control_wrapper #user_control_icon").live('touchend click', function (e) {
		e.preventDefault();
		jQuery(".site_side_container").toggleClass("opened");
		jQuery("html, body").toggleClass("side_container_opened");
	});

	jQuery(".sliding_close_helper_overlay").live('touchend click', function (e) {
		e.preventDefault();
	...
	start header search
	------------------------------------------- */
	jQuery(".header_search .search_form_icon").live('touchend click', function (e) {
		if (jQuery('.header_search').hasClass('expanded_search') === false) {
			...
			if (!jQuery('.header_search input.search_text').val()) {
				e.preventDefault();
				jQuery(".header_search").removeClass("expanded_search");
				jQuery(".header_search input[type='text']").blur();
			}
		}
	});
	/* --------
	...
	jQuery(".main_menu li a.mobile_menu_parent").on('touch click', function (event) {
